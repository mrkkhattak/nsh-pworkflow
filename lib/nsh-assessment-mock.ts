...
const questionnaireResponsesCurrent: QuestionResponse[] = [
  {
...
const questionnaireResponsesOct: QuestionResponse[] = [
  {
    questionId: "q-mental-001",
    question: "Over the past 2 weeks, how often have you felt down, depressed, or hopeless?",
    dimensionId: "mental",
    responseValue: 4,
    responseText: "Nearly every day",
  ...
  },
  {
    ...
    responseValue: 3,
    responseText: "Often",
    timestamp: "2024-10-15T10:34:00Z",
  },
  {
    questionId: "q-sdoh-002",
    question: "How often do transportation issues prevent you from attending medical appointments?",
  ...
  },
  {
    ...
    dimensionId: "engagement",
    responseValue: 2,
    responseText: "Most of the time",
    timestamp: "2024-10-15T10:37:00Z",
  },
  {
    questionId: "q-engagement-002",
    question: "How confident are you in managing your health conditions?",
    dimensionId: "engagement",
    responseValue: 3,
    responseText: "Not very confident",
  ...
  },
  {
    ...
    dimensionId: "sleep",
    responseValue: 4,
    responseText: "Less than 5 hours",
    timestamp: "2024-10-15T10:39:00Z",
  },
  {
    questionId: "q-sleep-002",
    question: "How often do you have trouble falling or staying asleep?",
    dimensionId: "sleep",
    responseValue: 4,
    responseText: "Almost every night",
  ...
  },
  {
    ...
    dimensionId: "pain",
    responseValue: 6,
    responseText: "6 - Moderately severe pain",
    timestamp: "2024-10-15T10:41:00Z",
  },
  {
    questionId: "q-pain-002",
    question: "How often does pain interfere with your daily activities?",
    ...
    responseValue: 3,
    responseText: "Frequently",
    timestamp: "2024-10-15T10:42:00Z",
  },
  {
    questionId: "q-diet-001",
    question: "How many servings of fruits and vegetables do you eat per day?",
    dimensionId: "diet",
    responseValue: 3,
    responseText: "Less than 2 servings",
    timestamp: "2024-10-15T10:43:00Z",
  },
  {
    questionId: "q-diet-002",
    question: "How often do you eat fast food or highly processed meals?",
    dimensionId: "diet",
    responseValue: 4,
    responseText: "Daily or almost daily",
    timestamp: "2024-10-15T10:44:00Z",
  },
]

const questionnaireResponsesJuly: QuestionResponse[] = [
  {
    questionId: "q-mental-001",
    question: "Over the past 2 weeks, how often have you felt down, depressed, or hopeless?",
    dimensionId: "mental",
  ...
  },
  {
    ...
    responseValue: 3,
    responseText: "Often",
    timestamp: "2024-07-20T10:34:00Z",
  },
  {
    questionId: "q-sdoh-002",
    question: "How often do transportation issues prevent you from attending medical appointments?",
    ...
    responseValue: 3,
    responseText: "Frequently",
    timestamp: "2024-07-20T10:35:00Z",
  },
  {
    questionId: "q-sdoh-003",
    question: "How often do you worry about having enough money to pay for healthcare costs?",
    ...
    responseValue: 4,
    responseText: "Almost always",
    timestamp: "2024-07-20T10:36:00Z",
  },
  {
    questionId: "q-engagement-001",
    question: "How often do you take your medications exactly as prescribed?",
    ...
    responseValue: 3,
    responseText: "Sometimes",
    timestamp: "2024-07-20T10:37:00Z",
  },
  {
    questionId: "q-engagement-002",
    question: "How confident are you in managing your health conditions?",
    dimensionId: "engagement",
    responseValue: 4,
    responseText: "Not at all confident",
    timestamp: "2024-07-20T10:38:00Z",
  },
  {
    questionId: "q-sleep-001",
    question: "How many hours of sleep do you typically get per night?",
    ...
    responseValue: 4,
    responseText: "Less than 5 hours",
    timestamp: "2024-07-20T10:39:00Z",
  },
  {
    questionId: "q-sleep-002",
    question: "How often do you have trouble falling or staying asleep?",
    ...
    responseValue: 4,
    responseText: "Almost every night",
    timestamp: "2024-07-20T10:40:00Z",
  },
  {
    questionId: "q-pain-001",
    question: "On a scale of 0-10, how would you rate your average pain level?",
    dimensionId: "pain",
    responseValue: 7,
    responseText: "7 - Severe pain",
    timestamp: "2024-07-20T10:41:00Z",
  },
  {
    questionId: "q-pain-002",
    question: "How often does pain interfere with your daily activities?",
    ...
    responseValue: 4,
    responseText: "Almost always",
    timestamp: "2024-07-20T10:42:00Z",
  },
  {
    questionId: "q-diet-001",
    question: "How many servings of fruits and vegetables do you eat per day?",
    dimensionId: "diet",
    responseValue: 4,
    responseText: "Less than 1 serving",
    timestamp: "2024-07-20T10:43:00Z",
  },
  {
    questionId: "q-diet-002",
    question: "How often do you eat fast food or highly processed meals?",
    ...
    responseValue: 4,
    responseText: "Daily or almost daily",
    timestamp: "2024-07-20T10:44:00Z",
  },
]
    ...
    assessments: [
      {
        ...
        questionnaireResponses: questionnaireResponsesCurrent,
        interventions: [
      ...
      },
      {
        ...
        date: "2024-10-15",
        patientId: 1,
        globalHealthIndex: 42,
        dimensions: [],
        actionItems: [],
        opportunities: { strengths: [], moderate: [], critical: [] },
        questionnaireResponses: questionnaireResponsesOct,
        interventions: ["Initial assessment and care plan development"],
        mcid: calculateMCID(48, 42, 5),
      },
      {
        id: "assess-003",
        date: "2024-07-20",
        patientId: 1,
        globalHealthIndex: 48,
        dimensions: [],
        actionItems: [],
        opportunities: { strengths: [], moderate: [], critical: [] },
        questionnaireResponses: questionnaireResponsesJuly,
        interventions: ["Baseline assessment at program enrollment"],
      },
    ],
  },
}
...
export function getAllAssessmentsForPatient(patientId: number): Assessment[] {
  const patientData = mockAssessmentData[patientId]
  return patientData ? patientData.assessments : []
}
