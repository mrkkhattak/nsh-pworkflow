...
export type GoalStatus = "on-track" | "at-risk" | "achieved" | "cancelled"
...
export type InterventionType = "Medication" | "Lifestyle" | "Therapy" | "Other"
export type InterventionStatus = "active" | "stopped" | "completed"
...
export interface Assessment {
  ...
  goals?: Goal[]
  dimensionInterventions?: Intervention[]
}
        ...
        goals: [
          {
            id: "goal-mental-1",
            dimensionId: "mental",
            description: "Reduce depression score by 50% through medication and therapy",
            baseline: 35,
            target: 18,
            current: 32,
            timeframe: "6 months",
            ...
            linkedInterventionIds: ["int-mental-1", "int-mental-2"],
          },
          {
            id: "goal-mental-2",
            dimensionId: "mental",
            description: "Achieve anxiety score below 30 through mindfulness and medication",
            baseline: 42,
            target: 28,
            current: 42,
            timeframe: "4 months",
            ...
            status: "at-risk",
            createdDate: "2025-01-01",
            linkedInterventionIds: ["int-mental-1", "int-mental-3"],
          },
          {
            id: "goal-sleep-1",
            dimensionId: "sleep",
            description: "Improve sleep duration to 7-8 hours nightly",
            baseline: 52,
            target: 25,
            current: 44,
            timeframe: "3 months",
            ...
            status: "on-track",
            createdDate: "2025-01-01",
            linkedInterventionIds: ["int-sleep-1", "int-sleep-2"],
          },
          {
            id: "goal-diet-1",
            dimensionId: "diet",
            description: "Reduce processed food intake and establish regular meal schedule",
            baseline: 42,
            target: 25,
            current: 33,
            timeframe: "4 months",
            ...
            status: "on-track",
            createdDate: "2025-01-01",
            linkedInterventionIds: ["int-diet-1"],
          },
          {
            id: "goal-sdoh-1",
            dimensionId: "sdoh",
            description: "Reduce financial stress through counseling and community resources",
            baseline: 58,
            target: 35,
            current: 36,
            timeframe: "6 months",
            ...
            linkedInterventionIds: ["int-sdoh-1", "int-sdoh-2"],
          },
          {
            id: "goal-physical-1",
            dimensionId: "physical",
            description: "Improve cardiovascular fitness through daily walking",
            baseline: 28,
            target: 15,
            current: 21,
            timeframe: "3 months",
            ...
            status: "on-track",
            createdDate: "2025-01-01",
            linkedInterventionIds: ["int-physical-1"],
          },
        ],
        dimensionInterventions: [
          {
            id: "int-mental-1",
            dimensionId: "mental",
            goalId: "goal-mental-1",
            type: "Medication",
            date: "2024-10-01",
            name: "Sertraline 75mg",
            details: "75mg daily, oral",
            status: "active",
            createdBy: "Dr. Sarah Martinez",
            notes: "Increased from 50mg due to partial response",
          },
          {
            id: "int-mental-2",
            dimensionId: "mental",
            ...
            details: "Weekly sessions, Dr. James Wilson",
            status: "active",
            createdBy: "Dr. James Wilson",
            notes: "Focus on cognitive restructuring and behavioral activation",
          },
          {
            id: "int-mental-3",
            dimensionId: "mental",
            goalId: "goal-mental-2",
            type: "Lifestyle",
            date: "2025-01-01",
            name: "Daily Mindfulness Meditation",
            details: "10 minutes daily using app",
            status: "active",
            createdBy: "Lisa Chen, LCSW",
            notes: "Patient reports finding it helpful for anxiety management",
          },
          {
            id: "int-mental-4",
            dimensionId: "mental",
            type: "Therapy",
            date: "2024-10-15",
            name: "Psychotherapy Initial Consultation",
            details: "Initial assessment, 60 minutes",
            status: "completed",
            createdBy: "Dr. James Wilson",
          },
          {
            ...
            details: "Consistent bedtime, no screens 1 hour before bed, cool room",
            status: "active",
            createdBy: "Dr. Sarah Martinez",
            notes: "Patient struggling with consistency on weekends",
          },
          {
            id: "int-sleep-2",
            dimensionId: "sleep",
            ...
            type: "Other",
            date: "2025-01-05",
            name: "Sleep Study Referral",
            details: "Referred to sleep medicine specialist",
            status: "active",
            createdBy: "Dr. Sarah Martinez",
            notes: "Appointment scheduled for January 25",
          },
          {
            id: "int-sleep-3",
            dimensionId: "sleep",
            ...
            date: "2024-11-15",
            name: "Trazodone 25mg",
            details: "25mg at bedtime as needed",
            status: "stopped",
            createdBy: "Dr. Sarah Martinez",
            stoppedDate: "2024-12-20",
            stoppedReason: "Patient experienced morning grogginess and preferred non-medication approach",
          },
          {
            id: "int-diet-1",
            dimensionId: "diet",
            ...
            details: "Weekly meal planning, focus on whole foods",
            status: "active",
            createdBy: "Nutrition Team",
            notes: "Patient making good progress with meal prep on Sundays",
          },
          {
            id: "int-sdoh-1",
            dimensionId: "sdoh",
            ...
            date: "2024-12-01",
            name: "Financial Counseling Services",
            details: "Monthly sessions with community financial counselor",
            status: "completed",
            createdBy: "Care Coordinator",
            notes: "Completed 6-week program successfully",
          },
          {
            id: "int-sdoh-2",
            dimensionId: "sdoh",
            ...
            date: "2024-12-05",
            name: "Community Food Bank Access",
            details: "Connected to local food bank, eligible for weekly pickup",
            status: "active",
            createdBy: "Care Coordinator",
          },
          {
            id: "int-physical-1",
            dimensionId: "physical",
            goalId: "goal-physical-1",
            type: "Lifestyle",
            date: "2025-01-01",
            name: "Daily Walking Program",
            details: "30 minutes daily, 5 days per week",
            status: "active",
            createdBy: "Physical Therapy Team",
            notes: "Patient consistently achieving 4-5 days per week",
          },
          {
            id: "int-pain-1",
            dimensionId: "pain",
            ...
            details: "Twice weekly sessions focusing on mobility",
            status: "active",
            createdBy: "Physical Therapy Team",
          },
        ],
...
export function getGoalsByDimension(assessment: Assessment, dimensionId: string): Goal[] {
  return (assessment.goals || []).filter((goal) => goal.dimensionId === dimensionId)
}

export function getInterventionsByDimension(assessment: Assessment, dimensionId: string): Intervention[] {
  return (assessment.dimensionInterventions || []).filter((int) => int.dimensionId === dimensionId)
}

export function getInterventionById(assessment: Assessment, interventionId: string): Intervention | undefined {
  return (assessment.dimensionInterventions || []).find((int) => int.id === interventionId)
}
